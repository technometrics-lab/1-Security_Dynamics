...
VersionFitz = "1.19.0"
VersionBind = "1.19.1"
VersionDate = "2021-10-23 00:00:01"
version = (VersionBind, VersionFitz, "20211023000001")
...
class Pixmap(object):
    ...
    def _samples_mv(self) -> AnyType:
        return _fitz.Pixmap__samples_mv(self)

    def _samples_ptr(self) -> AnyType:
...
class Annot(object):
    ...
    def get_pixmap(
        ...
        val = _fitz.Annot_get_pixmap(self, matrix, colorspace, alpha)
